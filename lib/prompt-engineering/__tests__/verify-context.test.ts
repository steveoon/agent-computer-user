...
离你比较近在{location}的奥乐齐门店有空缺，排班{schedule}，时薪{salary}元，有兴趣吗？`,
      systemInstruction: '如果对方提供的位置，能找到距离较近的门店，按以下话术回复：离你近的有{brand}的{location}门店，加我 wx，我给你约店长面试',
      conversationHistory: [
...
• 陆家嘴店：24小时营业，时薪24元`,
    ...
    const hasOtherBrands = 
      resultWithFilter.prompt.includes('必胜客') ||
      resultWithFilter.prompt.includes('麦当劳');
