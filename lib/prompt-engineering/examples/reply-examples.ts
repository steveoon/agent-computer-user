...
export class ReplyExampleRepository {
    ...
    this.examples.set("initial_inquiry", [
      {
        ...
        reasoningText: "候选人有明确意向，提供具体信息并询问位置以匹配门店",
      ...
      },
      {
        ...
        reasoningText: "候选人意向不明确，先了解岗位偏好",
    ...
    this.examples.set("location_inquiry", [
      {
        ...
        reasoningText: "有匹配门店，提供具体位置并推进面试",
  ...
  getSimilarExamples(
    ...
    if (!contextInfo || contextInfo.trim() === "") {
      const genericExamples = typeExamples.filter(
        example => !this.containsSpecificNumbers(example.output)
      );
